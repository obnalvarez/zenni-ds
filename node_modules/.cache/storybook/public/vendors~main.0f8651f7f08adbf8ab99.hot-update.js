...
/* harmony import */ var ansi_to_html__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ansi-to-html */ "./node_modules/ansi-to-html/lib/ansi_to_html.js");
/* harmony import */ var ansi_to_html__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(ansi_to_html__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var _storybook_core_events__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @storybook/core-events */ "./node_modules/@storybook/core-events/dist/esm/index.js");
/* harmony import */ var _storybook_client_logger__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @storybook/client-logger */ "./node_modules/@storybook/client-logger/dist/esm/index.js");
/* harmony import */ var _NoDocs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./NoDocs */ "./node_modules/@storybook/core-client/dist/esm/preview/NoDocs.js");
...
var document = global__WEBPACK_IMPORTED_MODULE_13___default.a.document,
    _global$FEATURES = global__WEBPACK_IMPORTED_MODULE_13___default.a.FEATURES,
...
var ansiConverter = new ansi_to_html__WEBPACK_IMPORTED_MODULE_14___default.a({
  escapeXML: true
});
/**
...
var StoryRenderer = /*#__PURE__*/function () {
  ...
  _createClass(StoryRenderer, [{
    ...
    value: function setupListeners() {
      ...
      if (this.channel) {
        this.channel.on(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].CURRENT_STORY_WAS_SET, function () {
          return _this.renderCurrentStory(false);
        });
        this.channel.on(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_ARGS_UPDATED, function () {
          return _this.forceReRender();
        });
        this.channel.on(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].GLOBALS_UPDATED, function () {
          return _this.forceReRender();
        });
        this.channel.on(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].FORCE_RE_RENDER, function () {
          return _this.forceReRender();
        });
      }
    }
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_UNCHANGED, Object.assign({}, metadata, {
                  name: name
                }));
              ...
              case 10:
                ...
                if (previousMetadata && (storyChanged || kindChanged || viewModeChanged)) {
                  this.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_CHANGED, metadata.id);
                }
              ...
              case 14:
                if (kindChanged || viewModeChanged) {
                  ...
                  react_dom__WEBPACK_IMPORTED_MODULE_12___default.a.unmountComponentAtNode(document.getElementById('docs-root'));
                }
              ...
              case 16:
                if (previousMetadata && (storyChanged || viewModeChanged)) {
                  ...
                  react_dom__WEBPACK_IMPORTED_MODULE_12___default.a.unmountComponentAtNode(document.getElementById('root'));
                }
    ...
    value: function checkIfLayoutExists(layout) {
      if (!layoutClassMap[layout]) {
        _storybook_client_logger__WEBPACK_IMPORTED_MODULE_17__[/* logger */ "a"].warn(Object(ts_dedent__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(_templateObject || (_templateObject = _taggedTemplateLiteral(["The desired layout: ", " is not a valid option.\n         The possible options are: ", ", none."])), layout, Object.keys(layoutClassMap).join(', ')));
      }
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 13:
                this.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_RENDERED, id);
                _context3.next = 19;
                break;
              ...
              case 21:
                this.showNoPreview();
                this.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_MISSING, id);
    ...
    value: function renderDocs(_ref8) {
      ...
      var DocsContainer = docs.container || function (_ref9) {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_11___default.a.Fragment, null, children);
      };

      var Page = docs.page || _NoDocs__WEBPACK_IMPORTED_MODULE_18__[/* NoDocs */ "a"]; // Docs context includes the storyStore. Probably it would be better if it didn't but that can be fixed in a later refactor

      react_dom__WEBPACK_IMPORTED_MODULE_12___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(DocsContainer, {
        context: Object.assign({
          storyStore: storyStore
        }, context)
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Page, null)), document.getElementById('docs-root'), function () {
        return _this3.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].DOCS_RENDERED, kind);
      });
    ...
    value: function renderException(err) {
      this.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_THREW_EXCEPTION, err);
      this.showErrorDisplay(err); // Log the stack to the console. So, user could check the source code.

      _storybook_client_logger__WEBPACK_IMPORTED_MODULE_17__[/* logger */ "a"].error(err);
    ...
    value: function renderError(_ref10) {
      ...
      this.channel.emit(_storybook_core_events__WEBPACK_IMPORTED_MODULE_16__["default"].STORY_ERRORED, {
        title: title,
        description: description
      });
...
var document = global__WEBPACK_IMPORTED_MODULE_12___default.a.document,
    FRAMEWORK_OPTIONS = global__WEBPACK_IMPORTED_MODULE_12___default.a.FRAMEWORK_OPTIONS;
var rootEl = document ? document.getElementById('root') : null;

var render = function render(node, el) {
  return new Promise(function (resolve) {
    react_dom__WEBPACK_IMPORTED_MODULE_14___default.a.render(node, el, resolve);
  });
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement(ErrorBoundary, {
              showMain: showMain,
              showException: showException
            }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement(Story, storyContext)); // For React 15, StrictMode & Fragment doesn't exists.

            element = Wrapper ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement(Wrapper, null, content) : content; // We need to unmount the existing set of components in the DOM node.
            ...
            if (!forceRender) {
              react_dom__WEBPACK_IMPORTED_MODULE_14___default.a.unmountComponentAtNode(rootEl);
            }
...
/*! exports used: createPortal, default, render */
...
//# sourceMappingURL=vendors~main.0f8651f7f08adbf8ab99.hot-update.js.map